...
public class ScreenShotsUtils {
    ...
    // צילום מסך של אלמנט
//    public static void takeElementScreenshot(WebDriver driver, WebElement element, String fileName) {
//        ensureDirectoryExists();
//
...
//            FileHandler.copy(src, new File(finalName));
//        } catch (IOException e) {
//            throw new RuntimeException("Cannot save element screenshot: " + e.getMessage());
//        }
//    }
}
